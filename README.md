...
- [Coding project style guide](#coding-project-style-guide)
  ...
  * [Fundamental code design decisions](#fundamental-code-design-decisions)
    ...
    + [CamelCase vs. underscore_each_word](#camelcase-vs-underscore-each-word)
  ...
  * [Other naming conventions](#other-naming-conventions)
    ...
    + [Variable, function and class names](#variable--function-and-class-names)
      - [Function & class names](#function---class-names)
      - [Constant names](#constant-names)
    + [What about when I'm importing code that uses its own style?](#what-about-when-i-m-importing-code-that-uses-its-own-style-)
  * [Accessibility guidelines](#accessibility-guidelines)
  * [HTML style](#html-style)
    + [When to add classes, when to add id's, and when to use markup in layout](#when-to-add-classes--when-to-add-id-s--and-when-to-use-markup-in-layout)
  * [Javascript style](#javascript-style)
  * [CSS style](#css-style)
    + [CSS id & class names](#css-id---class-names)
    + [CSS "sections"](#css--sections-)
    + [Things to avoid in your CSS](#things-to-avoid-in-your-css)
  * [Project management](#project-management)
    ...
    + [When to use a database vs. when to not use a database](#when-to-use-a-database-vs-when-to-not-use-a-database)
  * [On debugging](#on-debugging)
    + [Debugging JS](#debugging-js)
    + [Debugging CSS](#debugging-css)
    + [Debugging cross-browser issues](#debugging-cross-browser-issues)
    + [Debugging handheld issues](#debugging-handheld-issues)
  * [Resources](#resources)
